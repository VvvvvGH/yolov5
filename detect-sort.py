        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            if det is not None and len(det):
                ...
                for *xyxy, conf, cls in det:
                    ...
                    box = [float(i.cpu().numpy()) for i in xyxy]
                    box.append(float(conf.cpu().numpy()))
                    detections_to_sort.append(box)

                # Update sort
                # print(detections_to_sort)
                track_bbs_ids = mot_tracker.update(np.array(detections_to_sort))
